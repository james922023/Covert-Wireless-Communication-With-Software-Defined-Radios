...
#start_sequence = np.tile(start_sequence, 4681) #WORKING ONE
#start_sequence = np.tile(start_sequence, 2340) #TESTING ONE SEEMS TO WORK ALSO AND MUCH FASTER
start_sequence = np.tile(start_sequence, 1170) #TRYING TO MAKE EVEN FASTER
    ...
    while not success:
        ...
        if start_index==None:
            ...
            if(retries<4):
                ...
                print("gave up, transmission, couldnt sync. failed 4 times")
